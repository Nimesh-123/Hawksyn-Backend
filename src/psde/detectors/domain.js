...
function detectRegulatorySpecialist(cv, stats) {
    ...
    return {
        ...
        reasoning: isDetected ? 'Specializes in navigating complex regulatory environments and compliance frameworks.' : 'Limited explicit regulatory experience detected.',
...
function detectStrategyToExecutionLink(cv, stats) {
    ...
    return {
        ...
        reasoning: isDetected ? 'Demonstrated ability to both formulate high-level strategy and drive its operational implementation.' : 'Limited evidence of end-to-end strategy-to-execution linkage.',
        anchors: []
    };
}
