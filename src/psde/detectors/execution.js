...
function detectTransformationSpecialist(cv, stats) {
    ...
    return {
        ...
        reasoning: isDetected ? 'Strong track record in driving organizational or digital transformation programs.' : 'Limited specific transformation experience detected.',
        anchors: isDetected ? [
...
function detectStrategicExecution(cv, stats) {
    ...
    return {
        ...
        reasoning: isDetected ? 'Proven ability to execute strategic mandates including market entry and scaling.' : 'Limited evidence of high-stakes strategic execution.',
        anchors: isDetected ? [
...
function detectPostMergerNavigator(cv, stats) {
    ...
    return {
        ...
        reasoning: isDetected ? 'Expertise in post-merger integration (PMI) and realizing acquisition synergies.' : 'No explicit PMI experience detected.',
        anchors: []
    };
}
...
function detectCostOptimisationLead(cv, stats) {
    ...
    return {
        ...
        reasoning: isDetected ? 'Proven track record of driving significant cost optimisation or opex reduction.' : 'Limited evidence of cost-focused execution.',
        anchors: []
    };
}
