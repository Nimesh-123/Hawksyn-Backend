...
const cvController = require('../cv/cv.controller.js');
const integrityController = require('./integrity.controller.js');
const reportController = require('./report.controller.js');
const expertController = require('../expert/expert.controller.js');
const signalsController = require('../signals/signals.controller.js');
 ...
 * /runs/cv/report:
 *   get:
 *     summary: Retrieve the standalone CV parsing report (Candidate Snapshot) for the authenticated user BEFORE payment
 *     tags: ["5. Run Operations (AI Flow)"]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 *       404:
 *         description: User profile, parsed CV data, or PSDE results not found
 */
router.get('/cv/report', cvController.getLatestCvReport);
