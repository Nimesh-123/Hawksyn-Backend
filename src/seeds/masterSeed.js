    ...
    await RiskAuditorRegistry.insertMany([
        {
            ...
            caseCategories: ['CASE_AI_JOB_RISK'],
        ...
        },
        {
            ...
            password: hashedPassword,
            caseCategories: ['CASE_FREELANCE_SWITCH'],
        ...
        },
        {
            ...
            password: hashedPassword,
            caseCategories: ['CASE_ROLE_SWITCH'],
        ...
        },
        {
            ...
            password: hashedPassword,
            caseCategories: ['CASE_ROLE_OBSOLESCENCE'],
