...
const options = {
  definition: {
    ...
    tags: [
      ...
      { name: "10. Admin: Playbook Import", description: "Multi-sheet Excel Template Import/Export and Case Configuration" },
      { name: "11. Admin: AI Training Data", description: "Report rating and gold standard management" },
      { name: "12. Expert Panel: Auth", description: "Auth and profile management for Expert panel" },
      { name: "13. Expert Panel: Operations", description: "Expert auditor inbox and query resolution" },
      { name: "14. Notifications & Alerts", description: "In-app alerts and system notifications" },
    ],
  },

  apis: [
    path.join(__dirname, "../src/routes/index.route.js"),
